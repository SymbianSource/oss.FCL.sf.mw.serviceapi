...
#ifndef GET_HEADER_MESSAGE_H
#define GET_HEADER_MESSAGE_H
...
// Logging path
//_LIT( Kget_header_messageLogPath, "\\logs\\testframework\\get_header_message\\" ); 
// Log file
//_LIT( Kget_header_messageLogFile, "get_header_message.txt" ); 
...
/**
*  Cget_header_message test class for STIF Test Framework TestScripter.
*  ?other_description_lines
*
*  @lib ?library
*  @since ?Series60_version
*/
NONSHARABLE_CLASS(Cget_header_message) : public CScriptBase
    {
    public:  // Constructors and destructor
        ...
        */
        static Cget_header_message* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~Cget_header_message();
    ...
    private:
        ...
        */
        Cget_header_message( CTestModuleIf& aTestModuleIf );
