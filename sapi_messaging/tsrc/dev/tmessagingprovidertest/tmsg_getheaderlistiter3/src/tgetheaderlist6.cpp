...
*/
	...
	if(output)     
	    ...
	    //R//fs r//fs;
	    //r//fs.Connect();
	    //r//fs.Delete(_L("c:\\getheaderiter3_6.txt")); 
	    //fs.Create(r//fs, _L("c:\\getheaderiter3_6.txt"), EFileShareExclusive|EFileWrite)  ;
