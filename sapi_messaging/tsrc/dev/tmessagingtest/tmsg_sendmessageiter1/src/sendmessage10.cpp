...
class CTestAsync10: public CActive, public CMsgCallbackBase
{
public:
	static CTestAsync10* NewL();
	~CTestAsync10();
	void Start();
	TInt Result();
...
CTestAsync10* CTestAsync10::NewL()
	{
	CTestAsync10* self = new(ELeave)CTestAsync10();
	self->ConstructL();
	return self;
	}

CTestAsync10::~CTestAsync10()
	{
	Cancel();
...
void CTestAsync10::DoCancel()
	{
		
	}

void CTestAsync10::RunL()
	{
	TestFunc();
	}

void CTestAsync10::Start()
	{
	SetActive();
...
void CTestAsync10::NotifyResultL(TInt aErrCode, TAny* aResult)
	{
	//******************* set iResult ****************************
	iResult = aErrCode;
	//******************* set iResult ****************************
...
int sendmessage_test10(int, char**)
	{
	__UHEAP_MARK;
	CTestAsync10* test = CTestAsync10::NewL();
	test->Start();
	__UHEAP_MARKEND;
