...
void Ctprovidertest :: tgetlistgenericL(CFilterDetails *aDetails,TInt aParsedValue) 

{
   ...
   else
   {
    _LIT(KLog , "async test case for getlist api") ;
  	 iLog->Log(KLog) ;
    tgetlistasyncgenericL(aDetails);
   }
...
void Ctprovidertest :: tgetlistsyncgenericL(CFilterDetails *aDetails) 
{
   //Test case
...
void Ctprovidertest :: tgetlistasyncgenericL(CFilterDetails *aDetails) 
{
