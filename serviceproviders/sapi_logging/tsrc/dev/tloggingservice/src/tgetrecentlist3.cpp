...
//------------------------------------------------------------------
//getRecentList , Asynchronous test
// Gets the recent events as specified by the filter(Empty Filter)
//------------------------------------------------------------------
