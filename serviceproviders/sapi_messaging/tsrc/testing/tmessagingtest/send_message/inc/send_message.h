...
// Logging path
//_LIT( Ksend_messageLogPath, "\\logs\\testframework\\send_message\\" ); 
// Log file
//_LIT( Ksend_messageLogFile, "send_message.txt" ); 
...
/**
*  Csend_message test class for STIF Test Framework TestScripter.
*  ?other_description_lines
*
*  @lib ?library
*  @since ?Series60_version
*/
NONSHARABLE_CLASS(Csend_message) : public CScriptBase
    {
    public:  // Constructors and destructor
        ...
        */
        static Csend_message* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~Csend_message();
    ...
    private:
        ...
        */
        Csend_message( CTestModuleIf& aTestModuleIf );
