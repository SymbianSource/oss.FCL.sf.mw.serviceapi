...
// Iter-3 test work
    ...
    subject->Des().Copy(_L8("MMS Subject"));
	...
	if(output)     
	    ...
	    //R//fs r//fs;
	    //r//fs.Connect();
	    //r//fs.Delete(_L("c:\\getheaderiter3_7.txt")); 
	    ////fs.Create(r//fs, _L("c:\\getheaderiter3_7.txt"), EFileShareExclusive|EFileWrite)  ;
...
//			//fs.Write(_L8("Mtm Id :"));
		    ...
		    if(subjectdes.FindF(_L("MMS Subject")) == KErrNotFound)
			   val++;
