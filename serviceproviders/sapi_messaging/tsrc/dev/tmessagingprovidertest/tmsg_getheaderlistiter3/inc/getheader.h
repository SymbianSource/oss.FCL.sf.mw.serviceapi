...
extern int getheader_test4(int, char**);
extern int getheader_test5(int, char**);
extern int getheader_test6(int, char**);
extern int getheader_test7(int, char**);
...
NONSHARABLE_CLASS(Csapi_getheader) : public CScriptBase
    ...
    private:
       ...
       virtual TInt getheader_test4L( CStifItemParser& aItem );
       virtual TInt getheader_test5L( CStifItemParser& aItem );
       virtual TInt getheader_test6L( CStifItemParser& aItem );
       virtual TInt getheader_test7L( CStifItemParser& aItem );
