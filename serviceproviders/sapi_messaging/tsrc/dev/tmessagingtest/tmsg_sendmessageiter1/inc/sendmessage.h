...
#ifndef __SENDMESSAGE__H__ 
#define __SENDMESSAGE__H__ 
...
// Logging path
//_LIT( Ksapi_sendmessageLogPath, "\\logs\\testframework\\sendmessage1\\" ); 
// Log file
//_LIT( Ksapi_sendmessageLogFile, "sendmessage1.txt" ); 
...
/**
*  Csapi_sendmessage test class for STIF Test Framework TestScripter.
