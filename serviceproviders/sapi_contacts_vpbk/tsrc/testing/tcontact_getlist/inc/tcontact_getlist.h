...
*/
NONSHARABLE_CLASS(Ctmanualcontacts) : public CScriptBase
    {
    public:  // Constructors and destructor
        ...
        */
        static Ctmanualcontacts* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~Ctmanualcontacts();
    ...
    private:
        ...
        */
        Ctmanualcontacts( CTestModuleIf& aTestModuleIf );
        ...
        * @return Symbian OS error code.
        */
        virtual TInt GetList_Test1L( CStifItemParser& aItem );
        virtual TInt GetList_Test2L( CStifItemParser& aItem );
        virtual TInt GetList_Test3L( CStifItemParser& aItem );
        virtual TInt GetList_Test4L( CStifItemParser& aItem );
        virtual TInt GetList_Test5L( CStifItemParser& aItem );
        virtual TInt GetList_Test6L( CStifItemParser& aItem ); 
        virtual TInt GetList_Test7L( CStifItemParser& aItem ); 
