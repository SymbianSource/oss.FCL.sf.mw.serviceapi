...
NONSHARABLE_CLASS(Cteximport) : public CScriptBase
    ...
    private:
       ...
       virtual TInt Import_Test1L( CStifItemParser& aItem );
       virtual TInt Import_Test2L( CStifItemParser& aItem );
       virtual TInt Import_Test3L( CStifItemParser& aItem );
       virtual TInt Import_Test4L( CStifItemParser& aItem );
       virtual TInt Import_Test5L( CStifItemParser& aItem );
