...
#ifndef TAPPMANAGER_TEST_H
#define TAPPMANAGER_TEST_H
...
// Logging path
_LIT( KtappmgrtestLogPath, "\\logs\\testframework\\tappmgrtest\\" ); 
// Log file
_LIT( KtappmgrtestLogFile, "tappmgrtest.txt" ); 
_LIT( KtappmgrtestLogFileWithTitle, "tappmgrtest_[%S].txt" );
...
/**
*  Ctappmanager_test test class for STIF Test Framework TestScripter.
...
NONSHARABLE_CLASS(CAppManagerTest) : public CScriptBase
    ...
    private:
       ...
       virtual TInt launchJarL( CStifItemParser&  );
       ...
       TInt CancellaunchAppL( CStifItemParser& aItem  );
