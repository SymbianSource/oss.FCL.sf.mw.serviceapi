...
*/
NONSHARABLE_CLASS(CTCalendarUpdateTest) : public CScriptBase
    {
    public:  // Constructors and destructor
        ...
        */
        static CTCalendarUpdateTest* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~CTCalendarUpdateTest();
    ...
    private:
        ...
        */
        CTCalendarUpdateTest( CTestModuleIf& aTestModuleIf );
        ...
        */
        ...
        virtual TInt UpdateAppointmentEntryWithNewTimeL(CStifItemParser &aItem );
        virtual TInt UpdateAppointmentEntryL(CStifItemParser &aItem );
        ...
        virtual TInt UpdateAnniversaryL(CStifItemParser &aItem );
