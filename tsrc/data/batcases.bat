...
@perl -x batcases.bat %1 %2 %3 %4 %5 %6 %7 %8 %9 
@goto end
...
if($suite eq "sapi")
{
 ...
 "Negativemultipleimages",
  ...
  ["sapi_batcases.cfg", "sapi_batcases", "./", "/General/", "C:\\TestFramework"],							
   ["ant.jpg", "sapi_batcases", "/..messaging/internal/testing/data/", "/General/", "c:\\data\\Images"],
  ["dhoom2whis192701.mp3", "sapi_batcases", "/..messaging/internal/testing/data/", "/General/", "c:\\data\\sounds\\digital"],
   ["vcardimport.vcf", "sapi_batcases", "/..contacts_vpbk/internal/dev/tcontactprovidertest/data/", "/General/", "C:"],							
  ["vcardimportposbased.vcf", "sapi_batcases", "/..contacts_vpbk/internal/dev/tcontactprovidertest/data/", "/General/", "C:"],							
   ["Import.vcf", "sapi_batcases", "/..contacts_vpbk/internal/dev/tcontactprovidertest_sync/data/", "/General/", "C:\\data"],								
	...
	if($install eq "yes")
	{
		...
		my @cppList = ("tmediamgmtprovidertest.dll",
										"tmediamgmttest.dll",
										"tlmlandmarktests.dll",
										"Tlmdatabasetests.dll",
										"tlmcategorytests.dll",
										"TLandmarkProvider.dll",
										"tlmprovidercategorytests.dll",
										"TSAPILocTest.dll",
										"tlocationprovidertest.dll",
										"change_status_message.dll",
										"get_header_message.dll",
										"send_message.dll",
										"async_send_message.dll",
										"delete_message.dll",	
										"tcontacts_async.dll",
										"tcontacts_sync.dll",
										"tcontactprovidertest.dll",
										"tcontactprovidertest_sync.dll",
		               );
    @dllList = @cppList;
