...
/**
*  CMediaMgmt test class for STIF Test Framework TestScripter.
*  ?other_description_lines
*
*  @lib ?library
*  @since ?Series60_version
*/
NONSHARABLE_CLASS(CMediaMgmt) : public CScriptBase
    {
    public:  // Constructors and destructor
        ...
        */
        static CMediaMgmt* NewL( CTestModuleIf& aTestModuleIf );
    ...
    private:
        ...
        */
        CMediaMgmt( CTestModuleIf& aTestModuleIf );
        ...
        */
        ...
        virtual TInt GetFilesL( CStifItemParser& aItem );
        virtual TInt GetFilesInfoL( CStifItemParser& aItem );
    ...
    private:    // Friend classes
        //?friend_class_declaration;
        friend TInt GetFilesAsynchL( TAny *aCStifItemParser );
...
struct ParamPass
    {
    	CStifItemParser* it;
    	CStifLogger *log;
    	TMgCmdId CmdId ; // 0 for GetFiles and 1 GetFilesInfo
    	TInt meta;
    	TInt returnCode;

    };

class Callback : public MMgOperationObserver
{
