...
// Log file
_LIT( KtdeleteaddLogFile, "tdelete.txt" ); 
...
class Ctdeleteadd : public CScriptBase
    ...
    private:
        ...
        * @return Symbian OS error code.
        */
        virtual TInt Delete_Test1L( CStifItemParser& aItem );
        virtual TInt Delete_Test2L( CStifItemParser& aItem );
        virtual TInt Delete_Test3L( CStifItemParser& aItem );
        virtual TInt Delete_Test4L( CStifItemParser& aItem );
        virtual TInt Delete_Test5L( CStifItemParser& aItem );
        virtual TInt Delete_Test6L( CStifItemParser& aItem );  
        virtual TInt Delete_Test7L( CStifItemParser& aItem ); 
        virtual TInt Delete_Test8L( CStifItemParser& aItem );     
        virtual TInt Delete_Test9L( CStifItemParser& aItem );
        virtual TInt Delete_Test10L( CStifItemParser& aItem );  
        virtual TInt Delete_Test11L( CStifItemParser& aItem );
        virtual TInt Delete_Test12L( CStifItemParser& aItem );  
        virtual TInt Delete_Test13L( CStifItemParser& aItem );  
